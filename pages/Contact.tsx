...
const Contact: React.FC = () => {
  ...
  const handleWhatsAppRedirect = (e: React.FormEvent) => {
    e.preventDefault();
    // Numbers provided in prompt: 9440310266
    const primaryNumber = "919440310266";
    
    // Constructing the dynamic message based on form input as per reference image
    const text = `Name: ${formData.name} Email: ${formData.email} Phone: ${formData.phone} Message: ${formData.message}`;
    
    const url = `https://wa.me/${primaryNumber}?text=${encodeURIComponent(text)}`;
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto mt-12 mb-4">
            <div className="bg-white/40 p-6 rounded-lg border border-[#734332]/10">
              <h4 className="text-[#734332] font-bold mb-2">Call Us</h4>
              <p className="text-[15px] font-medium">+91-9440310266</p>
              <p className="text-[15px] font-medium">+91-6305197326</p>
            </div>
            <div className="bg-white/40 p-6 rounded-lg border border-[#734332]/10">
              <h4 className="text-[#734332] font-bold mb-2">Email Us</h4>
              <p className="text-[15px] font-medium">saipoornatrading@gmail.com</p>
            </div>
            <div className="bg-white/40 p-6 rounded-lg border border-[#734332]/10">
              <h4 className="text-[#734332] font-bold mb-2">Our Office</h4>
              <p className="text-[14px] font-medium">68-1-99 mulagada Mindi post<br/>Visakhapatnam 530012</p>
            </div>
          </div>
        </div>
      </section>
