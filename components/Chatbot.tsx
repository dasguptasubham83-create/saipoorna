...
const Chatbot: React.FC = () => {
  ...
  const getBotResponse = (userInput: string): string => {
    ...
    if (lowInput.includes('company') || lowInput.includes('about') || lowInput.includes('who are you')) {
      return "SAI POORNA TRADING AGENCIES was founded in 2020. We are a premier export-import firm specializing in heavy machinery for industrial, construction, and mining sectors.";
    }
    // Location
    ...
    if (lowInput.includes('contact') || lowInput.includes('phone') || lowInput.includes('number') || lowInput.includes('call')) {
      return "You can reach us at +91-9440310266 (Primary) or +91-6305197326 (Secondary). Email: saipoornatrading@gmail.com";
    }
    // Codes
